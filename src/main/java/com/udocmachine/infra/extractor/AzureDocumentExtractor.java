package com.udocmachine.infra.extractor;
...
import com.udocmachine.core.extractor.ExtractionException;
        ...
        if (paragraphs != null) {
            ...
            for (JsonNode paraNode : paragraphs) {
                ...
                if (text.length() > 0) {
                    ...
                    for (int i = 0; i < text.length(); i++) {
                        ...
                        if (currentBold != lastBold || currentItalic != lastItalic) {
                            if (currentRunText.length() > 0) {
                                textBlock.addInlineRun(new com.udocmachine.model.InlineRun(
                    ...
                    textBlock.addInlineRun(new com.udocmachine.model.InlineRun("", false, false));
                }
